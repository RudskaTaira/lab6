public class Cinema {
    ...
    public void bookSeats(int hallNumber, int row, int[] seats) throws SelectingSeatsException {
        ...
        for (int i = 0; i < seats.length; i++) {
            if (places[hallNumber][row - 1][seats[i] - 1] == 1) {
                throw new SelectingSeatsException("Seats are already taken");
            }
        }
        for (int i = 0; i < seats.length; i++) {
        ...
        for (int i = 0; i < seats.length; i++) {
            if (places[hallNumber][row - 1][seats[i] - 1] == 0) {
                ...
                if (countOfZero >= seats.length) {
                    throw new SelectingSeatsException("All selected seats are not taken");
                }
            } else {
    ...
    // method to print the number of searching columns
    ...
    // method to find the best available seats
    ...
    // method to automatically book the best available seats
